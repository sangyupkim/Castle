...
const SFX = (() => {
  ...
  return {
    ...
    shoot()    { tone(1500, 700, 0.045, 'square', 0.06); },
    cannon()   { noise(0.22, 0.28, 500); tone(150, 60, 0.24, 'sawtooth', 0.16); },
    hit()      { noise(0.06, 0.14, 1800); },
    kill()     { tone(520, 180, 0.14, 'square', 0.16); noise(0.1, 0.14, 800); },
